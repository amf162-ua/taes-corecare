...
export function Testimonials() {
  return (
    <section className="py-24 px-6 relative overflow-hidden">
      <div className="absolute inset-0 bg-[#0f0718]" />

      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-purple-600 rounded-full blur-[200px] opacity-20" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Miles de personas ya confían en nuestro benchmark
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 rounded-2xl bg-gradient-to-br from-[#1a0b2e]/50 to-[#2d1b4e]/50 backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"
            >
